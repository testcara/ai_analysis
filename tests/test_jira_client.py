...
from ai_analysis.jira_client import JiraClient
...
class TestJiraClient:
    ...
    def test_init_with_defaults(self):
        ...
        with patch.dict('os.environ', {'JIRA_URL': 'https://test.jira.com', 'JIRA_API_TOKEN': 'test-token'}):
            client = JiraClient()
    ...
    @patch('ai_analysis.jira_client.requests.get')
